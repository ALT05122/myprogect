<?php
/**
 * Construction_Builders Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Construction_Builders_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Construction_Builders_Repeater_Setting extends WP_Customize_Setting {
